...
= Development Has Been Seized =  

Due to Caldera Forms being [sunset/retired](https://calderaforms.com/2021/03/the-future-of-caldera-forms) on December 31, 2021 development of this pluging has been seized too. 

You are welcome to continue using the plugin "as is". However please expect the plugin to stop functioning on October 3, 2022 (because it uses out-of-band OAuth flow that will be [deprecated](https://developers.googleblog.com/2022/02/making-oauth-flows-safer.html) by Google by that date).

I have personally migrated all my forms to [Contact Form 7](https://wordpress.org/plugins/contact-form-7) plugin with the following extensions:
...
And created a plugin for integration with Google Sheets:

* [Integration with Google Sheets for Contact Form 7](https://wordpress.org/plugins/cf7-google-sheets))     
